...
LABEL_NODE = "Node.js"
LABEL_DB_DIR = "Diretório db/"
LABEL_EXPORTS_DIR = "Diretório exports/"
LABEL_CLASS = "Classificação"

# Constants for argument parser
PROG_NAME = "code-solver"
DESCRIPTION = "Code Solver AI - Ferramenta local para resolver problemas de programação com IA"
PROBLEM_HELP = "Descrição do problema de programação a ser resolvido"
PROBLEM_FILE_HELP = "Arquivo contendo a descrição do problema"
BATCH_FILE_HELP = "Arquivo com múltiplos problemas para processamento em lote"
